...
//        long time=System.currentTimeMillis();
        CtoGrey(pixels);
//        Log.i("java时间","java时间："+(System.currentTimeMillis()-time));
        Bitmap result = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        result.setPixels(pixels, 0, width, 0, 0, width, height);
        return result;
    }
    public static native void CtoGrey(int m[]);
...
//            }
//        }
        Ccomb(pixels1,pixels2);
        Bitmap result = Bitmap.createBitmap(width1, height1, Bitmap.Config.ARGB_8888);
        result.setPixels(pixels1, 0, width1, 0, 0, width1, height1);
        return result;
    }
    public static native void Ccomb(int p1[],int p2[]);
}